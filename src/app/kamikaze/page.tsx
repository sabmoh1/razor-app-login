...
export default function KamikazeLoginPage() {
  return (
    <KillSwitch pageName="kamikaze">
      <style jsx global>{`
        @keyframes glitch-v1-top-kamikaze {
        ...
        @keyframes glitch-v1-bottom-kamikaze {
          0% { transform: translateX(0); }
          25% { transform: translateX(4px); }
          50% { transform: translateX(-2px); }
          75% { transform: translateX(2px); }
        ...
        .glitch-v1-label::before {
          ...
          animation: glitch-v1-top-kamikaze 0.1s infinite linear;
          text-shadow: 2px 0 rgba(255,255,255,0.3);
        }

        .glitch-v1-label::after {
          clip-path: inset(50% 0 0 0);
          animation: glitch-v1-bottom-kamikaze 0.1s infinite linear;
        ...
        <div className="text-center mb-6">
            ...
            >
                <img 
                  ...
                  alt="Razor Logo" 
                  className="w-40 md:w-48 drop-shadow-[0_0_30px_rgba(255,77,77,0.2)] mb-2" 
                />
