    ...
    <>
      ...
      <style jsx global>{`
          ...
          *{box-sizing:border-box}
          ...
          .user-id-display { display: flex; align-items: center; gap: 8px; font-family: 'Orbitron', monospace; font-size: 16px; color: white; background: rgba(0,0,0,0.3); padding: 5px 10px; border-radius: 8px; border: 1px solid rgba(0,191,255,0.1); }
      ...
      <div className="wrap">
        <div className="panel">
          <div className="brand">
            ...
            <h1 className="neon-label">B16 TERMINAL</h1>
          </div>
            <a id="username" ref={usernameButtonRef} target="_blank" rel="noopener noreferrer">Telegram : @B16_VIP</a>
...
export default function B16WelcomePage() {
  return (
