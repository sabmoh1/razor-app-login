...
export default function LadybetAdmin() {
    ...
    useEffect(() => {
        ...
        const historyRef = ref(database, 'ladybet_config_history');
    ...
    const handleSaveConfig = async () => {
        ...
        const newConfig: LadybetConfig = { ...config, expires };
        ...
        return (
            <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center p-4">
                <div className="w-full max-w-sm space-y-4">
                    ...
                    <Button onClick={handleAdminLogin} disabled={isAuthenticating} className="w-full h-12" style={{backgroundColor: '#ff69b4', color: 'black'}}>
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-start p-4 space-y-8">
            <div className="w-full max-w-lg rounded-lg bg-gray-800 border border-gray-700 p-6 space-y-6">
                 ...
                 <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                        {DURATION_OPTIONS.map(opt => (
                            <Button key={opt.value} variant="outline" onClick={() => setDuration(opt.value)} className={cn("bg-gray-700 border-gray-600 hover:bg-gray-600", duration === opt.value && "ring-2 ring-pink-400")}>
                                {opt.label}
                            </Button>
                        ))}
                    </div>
                ...
                <Button onClick={handleSaveConfig} disabled={isSaving} className="w-full h-12 text-lg font-bold" style={{backgroundColor: '#ff69b4', color: 'black'}}>
            ...
            <div className="w-full max-w-lg rounded-lg bg-gray-800 border border-gray-700 p-6 space-y-4">
                 <h2 className="text-xl font-bold text-center flex items-center justify-center gap-2" style={{color: '#ff69b4'}}><History size={20}/> History</h2>
