...
function WelcomeContent() {
  ...
  return (
    <KillSwitch pageName="sigma">
      ...
      <style jsx global>{`
          :root{ --bg:#000; --neon-blue:#00bfff; --neon-white:#e6fff8; --neon-gray:#666; --accent:#00e5ff; }
          *{box-sizing:border-box}
          ...
          #crashValue { color: var(--neon-white); text-shadow: 0 0 8px var(--neon-blue); }
          .brand h1, .status-dot.connected { text-shadow: 0 0 5px var(--neon-blue), 0 0 10px var(--neon-blue), 0 0 15px var(--neon-blue), 0 0 20px var(--neon-blue); }
          .brand h1{ font-size:2rem;margin:0;color:var(--neon-blue);letter-spacing:4px;font-weight:900; }
          ...
          .connection-status { position: fixed; top: 15px; right: 20px; display: flex; align-items: center; gap: 8px; font-family: 'Orbitron', monospace; font-size: 16px; color: white; z-index: 9999; }
           .user-id-display { position: fixed; top: 15px; left: 20px; display: flex; align-items: center; gap: 8px; font-family: 'Orbitron', monospace; font-size: 16px; color: white; z-index: 9999; background: rgba(0,0,0,0.3); padding: 5px 10px; border-radius: 8px; border: 1px solid rgba(0,191,255,0.1); }
          ...
          .status-dot.connected{ background:var(--neon-blue); }
      ...
      <div className="wrap">
        <div className="panel">
          <div className="brand">
            ...
            <a id="username" target="_blank" rel="noopener noreferrer">Telegram : @sigma_betting_dz</a>
