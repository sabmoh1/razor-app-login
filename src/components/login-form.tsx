    ...
    <div className="w-full max-w-md font-orbitron">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-black text-neon-green text-glow uppercase">
          <span className="inline-block">RAZ</span><CreatePasswordForm adminPassword={process.env.NEXT_PUBLIC_ADMIN_PASSWORD || ''}>
              <span className="inline-block cursor-pointer hover:text-white transition-colors duration-300">O</span>
            </CreatePasswordForm><span className="inline-block">R TERMINAL</span>
        </h1>
